...
Contacts browser for the web in React.
...
```bash
git clone https://github.com/marcbperez/react-contacts
cd react-contacts
sudo ./gradlew
```
...
[issue-tracker]: https://github.com/marcbperez/react-contacts/issues
